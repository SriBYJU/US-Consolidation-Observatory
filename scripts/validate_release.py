...
required=[
'index.html','assets/styles.css','assets/app-core.js','assets/app.js','README.md','LICENSE','requirements.txt','MASTER_CHECKLIST.md','RESEARCH_MILESTONES.md',
...
html=(ROOT/'index.html').read_text(); js=(ROOT/'assets/app-core.js').read_text()+'\n'+(ROOT/'assets/app.js').read_text(); readme=(ROOT/'README.md').read_text(); methodology=(ROOT/'research/methodology.md').read_text(); limits=(ROOT/'research/limitations.md').read_text(); milestones=(ROOT/'RESEARCH_MILESTONES.md').read_text(); checklist=(ROOT/'MASTER_CHECKLIST.md').read_text()
...
for ref in ['assets/styles.css','assets/app-core.js','assets/app.js','data/panel_2014_2023.json','data/latest_2023.json','data/metadata.json','data/model_validation.json']:
