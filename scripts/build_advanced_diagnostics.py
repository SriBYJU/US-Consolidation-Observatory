...
def build_repro_manifest():
    files=['scripts/build_research_assets.py','scripts/run_score_sensitivity.py','scripts/build_advanced_diagnostics.py','scripts/validate_release.py','index.html','assets/app.js','assets/styles.css','research/model-card.md','research/hypothesis-registry.md','data/bds_state_sector_panel.csv.gz','data/model_validation.json','data/score_sensitivity_2023.json','data/research_diagnostics.json']
