...
6. **Derived artifacts** — versioned JSON/CSV artifacts in `/data`.
...
8. **Public display** — `assets/app.js` renders committed artifacts; it does not silently recompute research claims in the browser.
